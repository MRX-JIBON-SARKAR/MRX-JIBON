...
\033[0;31m▀▄▄▄▄▀▀▄▄▄▄▀▀▄▄▄▄▀▄▄▄▄▄▀▀▀▀▀▄▀▀▀▄▄▄▄▀
 ...
 \033[0;32m           Our Telegram Group t.me/usnexushacker
...
def main():
    menu()
    while(True):
        cnc = input('''\x1b[38;2;0;212;14m╔══[US\x1b[38;2;0;186;45mNEXUS\x1b[38;2;0;150;88mx\x1b[38;2;0;113;133mC\x1b[38;2;0;49;147m]
...
def login():
    ...
    response = requests.post('https://khalid10.xyz/usnexus-ddos/login.php', data={'username': username, 'password': password})

    # Check the response from the PHP script
    if response.status_code == 200 and response.json().get('authenticated'):
        print("⚡ Welcome to USNEXUS DDOS!")
        time.sleep(0.3)
        ascii_vro()
        main()
    else:
